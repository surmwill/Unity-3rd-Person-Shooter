...
public class Player : MonoBehaviour
{
    ...
    const string ANIM_RUNNING_FLAG = "running";
    ...
    private bool shootCoroutineRunning = false, aiming = false, gunEquipped = false;
    ...
    public void UpdatePlayerMovement()
    {
       ...
       //  rot_x -= GameInput.instance.mouseRotationY * GameInput.instance.playerRotationSpeed * Time.deltaTime;
        ...
        animator.SetBool(ANIM_RUNNING_FLAG, running);
    }
    ...
    void LateUpdate()
    {
        ...
        if(gunEquipped)
        {
            if(aiming)
            {
                gun.gunState = Gun.GunState.EQUIPPED_AIMING;
                ...
                if (Input.GetMouseButtonDown(0) && !shootCoroutineRunning)
                {
            ...
            {
                gun.gunState = Gun.GunState.EQUIPPED_RESTING;
